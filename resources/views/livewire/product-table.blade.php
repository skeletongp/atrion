            ...
            <table class="table-auto  lg:w-2/3 mx-auto">
                <thead>
                    <tr class="rounded-lg text-sm font-medium text-gray-900 text-left uppercase"
                        ...
                        <th class="px-4 py-2 bg-blue-100 text-center ">Producto</th>
                        <th class="px-4 py-2 bg-blue-100 text-center ">Categoría</th>
                        <th class="px-4 py-2 bg-blue-100 text-center ">Costo/Precio</th>
                            ...
                            <tr class=" border-b border-gray-200 hover:text-blue-200 py-10"
                                ...
                                <td class="px-4 py-4 text-center">
                                    <span class="text-red-400"><span
                                            class="fas fa-minus mr-2"></span>{{ $product->cost }}</span><br>
                                    <span class="text-green-400"><span
                                            class="fas fa-plus mr-2"></span>{{ $product->price }}</span>
                                </td>

                                {{-- Acciones --}}
                                <td class="px-4 py-4 bg-blue-100 border-b border-white text-center"><a href=""><span
                    ...
                    @else
                        <tr class=" border-b border-gray-200 hover:text-blue-200 py-10"
                            ...
                            <td class="px-4 py-4 border-b border-white text-center" colspan="5"
                                style="background-color: #293949">
                                <h2 class="font-bold uppercase text-lg select-none">No se ha encontrado ningún producto
                                </h2>
                            </td>
                        </tr>
                    @endif

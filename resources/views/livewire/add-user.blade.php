<div>
    ...
    <div>
        ...
        <div class="lg:flex">
            ...
            <div class="lg:w-1/2 mx-1 my-2">
                <x-input_text name="email" label="Correo" :oldValue="''" placeholder="Ingrese el correo" type="email"
                    model="email"></x-input_text>
        ...
        <div class="w-full">
            <x-multiselect name="permissions" label="Permisos" table="permissions"

...
<label for="input-menu" id="lb-close"
    class=" top-3 left-52 lb-close cursor-pointer flex-1 items-center justify-center fixed xl:hidden"
    style="z-index:80">
                ...
                <li class="sub-menu {{ request()->is('account/*') ? 'active' : '' }}">
                    ...
                    <ul>
                        <li class="{{ request()->routeIs('user.show') ? 'active' : '' }}"><a
                                href="{{ route('user.show', Auth::user()) }}"><i
                                    class="fas fa-user"></i><span>Mi
                                    perfil</span></a>
                        </li>
                    ...
                    <li class="sub-menu ">
                        ...
                        <ul>
                            ...
                            <li><a href="mail-compose.html"><i
                                        class="fas fa-sync-alt"></i><span>Recurrentes</span></a>
                            </li>
